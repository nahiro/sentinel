...
im2 = ax2.imshow(data[3],extent=(xmin,xmax,ymin,ymax),origin='upper',vmin=bmin,vmax=bmax,cmap=cm.jet,interpolation='none')
...
im3 = ax3.imshow(data[4],extent=(xmin,xmax,ymin,ymax),origin='upper',vmin=amin,vmax=amax,cmap=cm.jet,interpolation='none')
...
im4 = ax4.imshow(data[1],extent=(xmin,xmax,ymin,ymax),origin='upper',vmin=smin,vmax=smax,cmap=cm.jet,interpolation='none')
