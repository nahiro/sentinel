...
# Default values
SRCDIR = '/SATREPS/ipb/User/1_Spatial-information/Transplanting_date'
...
parser.add_argument('--version',default=VERSION,help='Product version (%(default)s)')
parser.add_argument('--date',default=None,help='Date in the format YYYYMMDD (%(default)s)')
...
dnam += '/{}'.format(dstr_year)
make_folder(dnam)
dnam += '/{}'.format(args.date)
make_folder(dnam)
